...
def get_conttags_inner(text, emowords, WVM):
    #print("emowords:\n", emowords)
...
def get_conttags(text, tags):
    emowords, WVM = get_tags_and_WVM(tags)
    output_all, output_sim_all = get_conttags_inner(text, emowords, WVM)
    ...
    for paragraph in paragraphs:
        ...
        output_this, output_sim_this = get_conttags_inner(paragraph, emowords, WVM)
